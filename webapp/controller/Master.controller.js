...
sap.ui.define([
		...
		"com/sap/sapmentors/sitreg/receptionist/model/grouper",
		"com/sap/sapmentors/sitreg/receptionist/model/GroupSortState"
	], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, grouper, GroupSortState) {
		"use strict";

		return BaseController.extend("com.sap.sapmentors.sitreg.receptionist.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.sap.sapmentors.sitreg.receptionist.view.ViewSettingsDialog", this);
